...
int main()
{
	...
	if (1) {
		...
		d1.set(2025, 12, 26);	//2025.12.26
		d2.set(2025, 12);		//2025.12.1
		d3.set(2025);		//2025.1.1

		cout << "d1应该是2025.12.26，实际为：";
		d1.show();
		cout << "d2应该是2025.12.1， 实际为：";
		d2.show();
	...
	if (1) {
		Date d1(2025, 12, 26), d2(d1), d3(d1); //都是2025.12.26

		cout << "测试set，带0值" << endl;
		cout << "==============" << endl;

		d1.set(2025, 0, 1);	//2025.12.1
		d2.set(0, 3, 18);		//2025.3.18
		d3.set(0, 0, 17);		//2025.12.17

		cout << "d1应该是2025.12.1， 实际为：";
		d1.show();
		cout << "d2应该是2025.3.18， 实际为：";
		d2.show();
		cout << "d3应该是2025.12.17，实际为：";
		d3.show();
	...
	if (1) {
		Date d1(2025, 12, 26), d2(d1), d3(d1), d4(d1);
	...
	if (1) {
		Date d1(2025, 12, 26), d2(d1), d3(d1), d4(d1), d5(d1);

		cout << "测试set，年、月、日(错误+含0) " << endl;
		cout << "==============================" << endl;

		d1.set(1899, 0, 0);   //2000.12.26
		cout << "d1应该是2000.12.26，实际为：";
		d1.show();
		d2.set(1899, 0, 32);  //2000.12.1
		cout << "d2应该是2000.12.1， 实际为：";
		d2.show();
		d3.set(0, 13, 0);      //2025.1.26
		cout << "d3应该是2025.1.26， 实际为：";
		d3.show();
		d4.set(0, 13, 32);    //2025.1.1
		cout << "d4应该是2025.1.1，  实际为：";
		d4.show();
		d5.set(0, 0, 32);     //2025.12.1
		cout << "d5应该是2025.12.1， 实际为：";
		d5.show();
